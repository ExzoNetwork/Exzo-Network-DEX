              ...
              <AutoRow>
                <LinkWrapper>
                  <ExternalLink
                    ...
                    href={`https://github.com/ExzoNetwork/interface/issues/new?assignees=&labels=bug&body=${encodedBody}&title=${encodeURIComponent(
                ...
                <LinkWrapper>
                  <ExternalLink id="get-support-on-discord" href="https://discord.gg/FcU5y8hZ3m" target="_blank">
                    <TYPE.link fontSize={16}>
