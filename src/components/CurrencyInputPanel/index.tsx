...
const Container = styled.div<{ hideInput: boolean }>`
  ...
  :hover {
    ...
    box-shadow: 0 0 5px rgba(110, 231, 183, 0.15), 0 0 10px rgba(110, 231, 183, 0.3);
  }
`
...
const CurrencySelect = styled(ButtonGray)<{ selected: boolean; hideInput?: boolean }>`
  ...
  cursor: pointer;
  user-select: none;
  border: 1px solid ${({ selected, theme }) => (!selected ? '#34d39988' ?? 'transparent' : theme.primaryTransparent)};
