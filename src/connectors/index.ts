...
import EXZOSWAPTOKEN_LOGO_URL from '../assets/svg/logo.svg'
...
// const SUPPORTED_CHAIN_IDS = [ChainId.MAINNET]
...
export const walletconnect = new WalletConnectConnector({
  supportedChainIds: SUPPORTED_CHAIN_IDS,
  rpc: {
    2370: 'https://testnet.exzo.technology',
    1229: 'https://mainnet.exzo.technology',
  },
...
export const walletlink = new WalletLinkConnector({
  ...
  appName: 'ExzoSwap Finance',
  appLogoUrl: EXZOSWAPTOKEN_LOGO_URL,
})
