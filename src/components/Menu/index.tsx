...
const CODE_LINK = 'https://github.com/ExzoNetwork/'
...
export default function Menu() {
  ...
  return (
    ...
    <StyledMenu ref={node as any}>
      ...
      {open && (
        <MenuFlyout>
          <MenuItem href="https://exzo.network">
            <Info size={14} />
            <div>About</div>
          </MenuItem>
          {/*
          <MenuItem href="https://docs.exzo.network">
            <BookOpen size={14} />
            <div>Docs</div>
          </MenuItem>
          */}
          ...
          {/*
          <MenuItem href="https://discord.gg/FcU5y8hZ3m">
