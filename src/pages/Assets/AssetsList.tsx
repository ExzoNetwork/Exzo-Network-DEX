...
import { Exzo, XEXZOSWAPTOKEN } from 'constants/tokens'
...
export const AssetsListPage = () => {
  ...
  const ethBalance = useCurrencyBalance(account ?? undefined, Exzo.onChain(chainId || ChainId.MAINNET) as Currency)
    ...
    return (
      [ethBalance, ...Object.values(tokenBalances)]
        ...
        .filter((a) => {
          ...
          const xDiff = XEXZOSWAPTOKEN[chainId]
          if (!xDiff) {
            return true
          }
  ...
  return (
    <AssetContextProvider>
      <AssetsListContainer>
        ...
        <HeadingWithPotion
          heading="My Assets"
          description="Overview of assets, liquidity-, farm- and staking positions on ExzoSwap"
        />
        <TotalAssets
