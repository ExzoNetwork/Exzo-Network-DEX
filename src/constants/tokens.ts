...
import { WXZO, Exzo } from './native-token'
...
export const XZO = Exzo.onChain(ChainId.MAINNET)
...
export const ATOM = {
  //@TODO: FIX MAINNET
  [ChainId.MAINNET]: new Token(ChainId.MAINNET, '0x138CFE5A6e28be207Ff06845C0ef6A2786469E44', 18, 'MATOM', 'Mock ATOM'),
...
export const MXZO = makeToken('XZO', 'MXZO', 18, {
  /**
...
export const EXZOSWAPTOKEN = makeToken('FNBS', 'FNBS', 18, {
...
export const XEXZOSWAPTOKEN = makeToken('xFNBS', 'xFNBS', 18, {
