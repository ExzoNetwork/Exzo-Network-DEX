            ...
            <AutoColumn gap="md">
              ...
              <RowBetween style={{ marginBottom: '1rem' }}>
                <TYPE.white fontSize={14}>
                  {`ExzoSwap LP tokens are required. Once you've added liquidity to the ${token0?.symbol}-${token1?.symbol} pool you can stake your liquidity tokens on this page.`}
                </TYPE.white>
              </RowBetween>
              <ButtonPrimary
                padding="8px"
          ...
          <StyledBottomCard dim={stakingInfo?.stakedAmount?.equalTo(JSBI.BigInt(0))}>
            ...
            <AutoColumn gap="md">
              ...
              <RowBetween style={{ alignItems: 'baseline' }}>
                ...
                <TYPE.white>
                  ESWAP-LP {currency0?.symbol}-{currency1?.symbol}
                </TYPE.white>
              </RowBetween>
              <RowBetween style={{ alignItems: 'baseline' }}>
